...
-(void)setupQRCode:(NSString *)code
{
    ...
    NSString *qrCode = [dir stringByAppendingPathComponent:@"qR.png"];
    char filename [[qrCode length] + 1];
    [qrCode getCString:filename maxLength:[qrCode length] + 1 encoding:NSUTF8StringEncoding];
    ...
    NSData *data = [[NSData alloc] initWithContentsOfFile:qrCode];
